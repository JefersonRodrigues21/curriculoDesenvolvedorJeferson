...
link:
http://127.0.0.1:50955/public/curriculo_jeferson.html


JEFERSON RODRIGUES

Contato: (16) 98243-4616 (WhatsApp)

E-mail: jeferson.rodrigues.devgeek@gmail.com

Linkedin: https://www.linkedin.com/in/jeferson-rodrigues-devgeekjs

GitHub: https://github.com/JefersonRodrigues21

RESUMO PROFISSIONAL

Profissional com experiência em sistemas de gestão pública, ambientes que exigem organização, disciplina foco e atendimento ao cliente de forma consultiva, ágil e acolhedora, desenvolvida em 8 anos de atuação no Exército Brasileiro e 8 anos como Assistente Administrativo na empresa Asa Centro de Negócios Administrativos. Curso Análise e Desenvolvimento de Sistemas e Pós-graduação em Desenvolvimento Full Stack.


Busco constantemente aprimorar meus conhecimentos e estou comprometido com o desenvolvimento de uma carreira sólida na área de TI, com foco em atendimento ao cliente e resolução de problemas técnicos.

Meu objetivo de vida é qualificação contínua, construir networking e me especializar em novas tecnologias e, ao mesmo tempo, contribuir para um ambiente de trabalho colaborativo, onde posso agregar valor e crescer junto com a empresa.

HABILIDADES TÉCNICAS

Lógica de Programação;
Front-end: Html, Css e JavaScript, TypeScript;
Back-end: Python, Java, Node.js, e .NET;
Banco de dados: SQL Server;
Ferramentas e controle de versão: Git, GitHub, VS Code;
...
https://github.com/JefersonRodrigues21/pokedexApp
...
Espanhol: Intermediário (em estudo para nível avançado).